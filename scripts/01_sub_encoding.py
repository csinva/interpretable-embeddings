...
params_coupled_dict = {
    ('feature_space', 'qa_questions_version', 'seed', 'ndelays'): [
        ...
        # version v3
        # ('qa_embedder-10', 'v3', 1, 4),
        # ('qa_embedder-10', 'v3', 2, 8),
        # ('qa_embedder-10', 'v3', 3, 12),
        # ('qa_embedder-10', 'v3', 4, 8),
        ('qa_embedder-10', 'v3', 5, 8),
        ('qa_embedder-10', 'v3', 6, 8),
        ('qa_embedder-10', 'v3', 7, 8),
        ('qa_embedder-10', 'v3', 8, 8),
        ('qa_embedder-10', 'v3', 9, 8),
        ('qa_embedder-10', 'v3', 10, 8),
        ('qa_embedder-10', 'v3', 11, 8),
        ('qa_embedder-10', 'v3', 12, 8),
