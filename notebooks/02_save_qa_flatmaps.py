...
def get_weights_top():
    ...
    qa = r[(r.feature_space == 'qa_embedder-5') * (r.pc_components == -1)
    ...
    print(f'{args.feature_space=}, {args.pc_components=}, {args.ndelays=}')
...
def save_coefs_csv(weights):
    ...
    df.to_csv('../qa_results/questions_v1.csv', index=False)
    return df
